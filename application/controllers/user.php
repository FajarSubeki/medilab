...
class User extends CI_Controller {
    ...
    public function index(){
        ...
        $data['user'] = $get_data;
        $this->template->load('admin/index_admin','admin/rs/user/master_user',$data);
    ...
    Public function search_user(){
        ...
        $hasil = $this->load->view('admin/rs/user/list_datauser',$data);
    ...
    public function add_edit_user($id=''){
        ...
        $this->template->load('admin/index_admin','admin/rs/user/add_edit_master_user',$data);
