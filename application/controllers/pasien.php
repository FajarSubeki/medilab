...
class Pasien extends CI_Controller{
    ...
    $data['data_pasien'] = $this->MPasien->get_data();
		$this->template->load('admin/index_admin','admin/rs/pasien/index',$data);
  ...
  public function add_edit($id=''){
    ...
    $this->template->load('admin/index_admin','admin/rs/pasien/add_edit',$data);
  ...
  public function add_edit_save($id=''){
    ...
    redirect("index.php/pasien/index");
